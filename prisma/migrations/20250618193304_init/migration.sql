...
-- CreateIndex
CREATE UNIQUE INDEX "Debate_joinCode_key" ON "Debate"("joinCode");
...
-- AddForeignKey
ALTER TABLE "Debate" ADD CONSTRAINT "Debate_proUserId_fkey" FOREIGN KEY ("proUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
